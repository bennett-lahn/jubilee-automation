...
G0 X40.0 F1200         ; Rapid to the approach position without any current tool.
G0 Y270.0 F1200        ; Follow dogleg pattern to ensure trickler is safe
; G0 X40.0 Y270.0 F6000 ; Tool 0 ready position (kept for reference)  
